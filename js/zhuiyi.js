    var rule = {
        ...
        class_url: '1&7&8&3',
        play_parse: true,
        lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://115.231.220.36:9999/jx/tvbox/xty.php?url="},
{"+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
        limit: 6,
