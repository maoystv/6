var rule = {
    ...
    host: 'http://xuanyy.yy365.vip/api.php/app/',
    ...
    class_url:'1&2&3&4',
    play_parse: true,
    lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://jx.ghlyys.com/?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
    limit:6,
